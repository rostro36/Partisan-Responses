...
class dataset:
  ...
  def mkVocabs(self,args):
    ...
    generics = ['<subject>', '<object>'] #['<method>','<material>','<otherscientificterm>','<metric>','<task>'] #TODO: Change Me
    ...
    specials = "subject object".split(" ") #"method material otherscientificterm metric task".split(" ") #TODO: Change Me
    for x in specials:
      for y in range(40):
        s = "<"+x+"_"+str(y)+">"
